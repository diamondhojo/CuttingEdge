...
def create_database(app):
    ...
    if not path.exists("files/" + DB_NAME):
        ...
        cur.execute('INSERT INTO client(id, first_name, last_Name, email, address, date_created, date_updated) VALUES (1, \'John\', \'Appleseed\', \'jappleseed@gmail.com\', \'1795 Brentwood Drive\', \'2021-10-04 18:38:54.501512\', \'2021-10-04 18:38:54.501512\')')
        cur.execute("INSERT INTO employee VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", (1, 'Lorem', 'Ipsum', 'lipsum@gmail.com', '139 Young Road', password, 'Manager', '2021-10-04 18:38:54.501512', '2021-10-04 18:38:54.501512'))
